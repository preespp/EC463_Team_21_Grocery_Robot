...
def generate_launch_description():
    ...
    fixed_pose_init = ExecuteProcess(
        cmd=[
            "ros2",
            "run",
            "robot_navigation",
        ...
        condition=IfCondition(
            PythonExpression(["'", LaunchConfiguration("startup_mode"), "' == 'fixed_pose'"])
        ),
    )
    ...
    global_localization = ExecuteProcess(
        ...
        condition=IfCondition(
            PythonExpression(
                ["'", LaunchConfiguration("startup_mode"), "' == 'global_localization'"]
            )
        ),
    )

    global_localization_spin = ExecuteProcess(
        cmd=[
            "ros2",
            "run",
            "robot_navigation",
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("localization_init_delay_sec", default_value="3.0"),
            DeclareLaunchArgument("global_localization_motion_delay_sec", default_value="4.0"),
            ...
            TimerAction(
                period=LaunchConfiguration("localization_init_delay_sec"),
                actions=[fixed_pose_init, global_localization],
            ),
            TimerAction(
                period=LaunchConfiguration("global_localization_motion_delay_sec"),
                actions=[global_localization_spin],
            ),
            TimerAction(
