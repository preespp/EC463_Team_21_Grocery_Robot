...
def create_restock_tree(bb):
    ...
    process_one_item = py_trees.composites.Sequence("ProcessRestockItem", memory=True, children=[
        ...
        py_trees.composites.Selector("PlaceWithRecovery", memory=True, children=[
            py_trees.composites.Sequence("PlaceSequence", memory=True, children=[
                bt_nodes.VerifyPosition(),
                bt_nodes.AdjustOrientation(),
