...
class Metaclass_Order(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robot_interfaces.msg import OrderItem
...
class Order(metaclass=Metaclass_Order):
    ...
    _fields_and_field_types = {
        ...
        'role': 'string',
        'requester_id': 'string',
        'items': 'sequence<robot_interfaces/OrderItem>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedString(),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['robot_interfaces', 'msg'], 'OrderItem')),  # noqa: E501
    )
